...
void getPrime() {
    ...
    for (int i = 2; i <= 100000; ++i) {
        if (prime[i]) {
            int j = i * 2;
            while (j <= 100000) { prime[j] = false; j += i; }
        }
    }
}
