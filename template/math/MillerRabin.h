/**
 * Description: Miller-Rabin Primality Test for checking if a number is prime.
 *  Probabilistic test with high accuracy for large numbers.
 * Time: $O(K \log^3 N)$, where $K$ is the number of iterations.
 */
