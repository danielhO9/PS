/**
 * Description: Persistent Segment Tree supports range queries and updates with versioning.
 *  Allows access to any previous version of the segment tree.
